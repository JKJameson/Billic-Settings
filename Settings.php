...
class Settings {
	...
	function admin_area() {
		...
		foreach ($modules as $module) {
			...
			echo '<li' . ($current_module == $module['id'] ? ' class="active"' : '') . '><a href="#" data-toggle="tab" onClick="loadSettingsPage(\'' . $module['id'] . '\')"><i class="icon-' . $icon . '"></i> ' . $module['id'] . '</a></li>';
		}
		echo '</ul></div><div class="col-md-10"><div class="tab-content" style="background: #fff;padding: 0 20px 0 20px;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;text-align: justify;text-justify: inter-word"><div class="tab-pane active" id="settingsPage" style="padding:10px"><div id="dashboardLoader">Loading...</div></div></div></div></dov>';
	}
}
